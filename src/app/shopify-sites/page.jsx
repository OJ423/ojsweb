        ...
        <main className="flex min-h-min flex-col w-full items-center justify-center">
          ...
          <ColumnsTwoFullH>
            <div className="flex flex-col gap-4">
              ...
              With extensive experience working with both emerging brands and established businesses, I know how to create a Shopify store that meets your unique requirements.
              </p>
              <p className="text-lg leading-7 font-medium">
              Shopify&apos;s robust platform allows for a wide range of customisations. From unique themes to advanced integrations, I can build a store that not only looks great but also provides an exceptional shopping experience for your customers.
              </p>
