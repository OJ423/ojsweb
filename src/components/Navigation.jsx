...
export default function Navigation() {
  ...
  return (
    <>
      ...
      <header className={`${!menuOpen ? 'translate-x-[-100%] md:translate-x-0': 'translate-x-0'} transition-all duration-500 bg-white w-full bottom-0 left-0 fixed md:w-2/5 xl:w-1/4 min-h-screen md:sticky md:top-0 flex flex-col gap-4 justify-center items-center px-8 my-auto py-8 shadow-reverse font-bold text-gray-600 z-40`}>
        <Link
